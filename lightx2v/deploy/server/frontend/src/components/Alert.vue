...
<template>
            ...
            <div v-cloak>
                <transition
                    ...
                    <div v-if="alert.show"
                        class="fixed left-1/2 transform -translate-x-1/2 z-[70] w-auto min-w-[280px] sm:min-w-[320px] max-w-[calc(100vw-3rem)] sm:max-w-xl px-6 sm:px-6 transition-all duration-500 ease-out"
                        :style="alertPosition">
