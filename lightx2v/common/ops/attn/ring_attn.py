...
class RingAttnWeight(AttnWeightTemplate):
    ...
    def apply(self, q, k, v, img_qkv_len, cu_seqlens_qkv, attention_module=None, attention_type="flash_attn2", seq_p_group=None, model_cls=None, use_fp8_comm=False, enable_head_parallel=False):
        """
